...
/** Precise shop coordinates (DMS + decimal) */
const DMS = `23°28'42.7"N 58°15'38.9"E`;
const LAT = 23.478528;   // decimal of 23°28'42.7"N
const LNG = 58.260806;   // decimal of 58°15'38.9"E

// Google Maps is happiest with decimals for query/embed
...
export default function Location() {
  ...
  return (
    <section id="location" className="scroll-offset py-20 md:py-28">
      <div className="mx-auto max-w-7xl px-4 grid lg:grid-cols-2 gap-10 items-start">
        <motion.div variants={fade} initial="hidden" whileInView="show" viewport={{ once: true }} className="space-y-5 text-start">
          ...
          <p className="text-lg text-neutral-700 dark:text-white/70">
            {t("location.sub") || "Find us in Muscat — convenient access, secure indoor drop-off, and concierge reception."}
          </p>
