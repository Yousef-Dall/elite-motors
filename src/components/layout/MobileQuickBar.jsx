...
export default function MobileQuickBar() {
  ...
  return (
    <div style={safePad} className={["fixed bottom-0 left-0 right-0 z-50 md:hidden transition-transform duration-250 ease-out will-change-transform", visible ? "translate-y-0" : "translate-y-full"].join(" ")}>
