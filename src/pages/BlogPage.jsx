...
const posts = [
  {
    ...
    date: "2025-08-10",
    excerpt: { en: "ECU tune, Inconel exhaust, coilovers, and corner balancing for road & track.", ar: "برمجة ECU، عادم إنكونيل، سسبيشن قابل للتعديل، ووزن أركان مضبوط للشارع والحلبة." },
  ...
  },
  {
    ...
    date: "2025-07-01",
    excerpt: { en: "We break down toe, camber, and caster—and why your car feels transformed.", ar: "نشرح لك زوايا الكامبر والتو والكاستر — ولماذا سيارتك تصبح مختلفة تمامًا." },
...
export default function BlogPage() {
  ...
  return (
    <>
      <SEO title="Articles" description="Build stories, ownership tips, and workshop updates." url="https://elitemotors.om/blog" />
      <div dir={isAr ? "rtl" : "ltr"} className="min-h-screen">
        <main className="mx-auto max-w-7xl px-4 py-16 md:py-24">
          <header className={`${isAr ? "text-right" : "text-left"} mb-8`}>
            <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight">{t("blog.title") || (isAr ? "المقالات" : "Articles")}</h1>
