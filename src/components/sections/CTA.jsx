    ...
    <div className="mx-auto max-w-7xl px-4">
      <div
        className="relative overflow-hidden rounded-3xl border border-black/10 dark:border-white/10
                   bg-gradient-to-r from-cyan-500/15 via-indigo-500/12 to-fuchsia-500/15"
      >
        ...
        >
          ...
          <div
            className={
              isAr ? "text-left md:text-left" : "text-left md:text-right"
            }
          >
            <a
              href="#contact"
              className="em-shine inline-flex items-center gap-2 px-6 py-3 rounded-2xl text-white font-semibold
