...
const WA_TEXT = encodeURIComponent(
  "Hi Elite Motors, I'd like to inquire about your services."
);
      ...
      <div className="mx-auto max-w-7xl px-4 py-2 bg-white/90 dark:bg-neutral-900/90 backdrop-blur border-t border-black/10 dark:border-white/10 rounded-t-2xl shadow-[0_-6px_20px_rgba(0,0,0,0.12)]">
        <div className="grid grid-cols-3 gap-3">
          <a
            ...
            className="flex flex-col items-center justify-center gap-1 py-1 text-sm text-neutral-700 dark:text-white"
          >
            <Phone className="h-5 w-5" />
            <span>Call</span>
          </a>
          <a
            href={`https://wa.me/${CONTACT.WHATSAPP}?text=${WA_TEXT}`}
            target="_blank"
            rel="noreferrer"
            className="flex flex-col items-center justify-center gap-1 py-1 text-sm text-neutral-700 dark:text-white"
          >
