    ...
    <div className="mx-auto max-w-7xl px-4 grid md:grid-cols-2 gap-10 text-start">
      ...
      >
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div>
            <label className="text-sm text-neutral-600 dark:text-white/70">
              {t("contact.name") || "Name"}
            </label>
            <input
              required
        ...
        <div>
          ...
          <input
            ...
            placeholder={
              t("contact.placeholderVehicle") || "e.g., Ferrari 296 GTB"
            }
            className="mt-1 w-full px-3 py-2 rounded-xl border outline-none
                       bg-white text-neutral-900 placeholder-neutral-500
                       dark:bg-neutral-900 dark:text-white dark:placeholder-white/50
        ...
        <div>
          <label className="text-sm text-neutral-600 dark:text-white/70">
            {t("contact.help") || "How can we help?"}
          </label>
          <textarea
            rows={4}
            required
            ...
            placeholder={
              t("contact.placeholderHelp") ||
              "Maintenance, tuning, detailing…"
            }
            className="mt-1 w-full px-3 py-2 rounded-xl border outline-none
                       bg-white text-neutral-900 placeholder-neutral-500
                       dark:bg-neutral-900 dark:text-white dark:placeholder-white/50
        ...
        {ENDPOINT ? (
          ...
          <div className="text-xs text-neutral-500 dark:text-white/40">
            Tip: set <code>VITE_CONTACT_ENDPOINT</code> for direct delivery.
          </div>
        )}
      </form>
    </div>
