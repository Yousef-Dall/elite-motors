          ...
          <div className="flex items-center gap-3">
            {socials.map(({ href, label, Icon }) => (
              <a
                ...
                className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-black/10 bg-white/70 hover:bg-white/90 dark:border-white/15 dark:bg-white/5 dark:hover:bg-white/10 transition-all duration-300 hover:scale-105"
                title={label}
              >
